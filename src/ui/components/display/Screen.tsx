...
export default function Screen({ className = '', result, setBlinker, setExpression, expression, ...props }: Props) {
    ...
    return (
        <div className={` text-nowrap  flex flex-col justify-between selection:bg-[var(--color-accent-1)] bg-[var(--color-screen-bg)] font-[DIG] w-full px-[0.85rem] pt-[0.2rem] sm:pt-[0.3rem] pb-[0.3rem] rounded-t-[1.4rem] overflow-hidden  text-[1.7rem] text-white h-[6rem]  ${className}`} {...props}>
